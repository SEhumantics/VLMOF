package railway {
  ...
  class Region extends railway::RailwayElement {
    ...
    elements : railway::TrackElement [0..*] ordered nonunique composite;
  }
...
object reg : railway::Region {
  observe railway::RailwayElement::id = [505];
  observe railway::Region::sensors = [];
  observe railway::Region::elements = [@seg, @seg];
}
object seg : railway::Segment {
